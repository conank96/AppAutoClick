 ...
 */
package com.example.appautoclick.baseui.overlayviews.condition.selector
...
import com.example.appautoclick.baseui.overlayviews.condition.ConditionSelectorView
import com.example.appautoclick.baseui.overlayviews.condition.SelectorViewComponent
...
internal class Selector(
    ...
    private fun onNewDownEvent(eventX: Float, eventY: Float): Boolean {
        currentGesture = when {
            ResizeLeft.getGestureArea(selectedArea, handleSize, innerHandleSize)
                .contains(eventX, eventY) ->
                ResizeLeft
            ResizeTop.getGestureArea(selectedArea, handleSize, innerHandleSize)
                .contains(eventX, eventY) ->
                ResizeTop
            ResizeRight.getGestureArea(selectedArea, handleSize, innerHandleSize)
                .contains(eventX, eventY) ->
                ResizeRight
            ResizeBottom.getGestureArea(selectedArea, handleSize, innerHandleSize)
                .contains(eventX, eventY) ->
                ResizeBottom
