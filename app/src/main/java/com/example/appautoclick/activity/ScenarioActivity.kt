 ...
 */
package com.example.appautoclick.activity
...
import com.buzbuz.smartautoclicker.activity.ScenarioViewModel
import com.example.appautoclick.SmartAutoClickerService
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        screenCaptureLauncher = registerForActivityResult(ActivityResultContracts.StartActivityForResult()) {result->
            if (result.resultCode != RESULT_OK) {
                ...
                scenarioViewModel.loadScenario(result.resultCode, result.data!!, requestedScenario!!)
                finish()
            }
        }
    }
