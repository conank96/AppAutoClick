...
import com.example.appautoclick.overlays.utils.setIconTint
import com.example.appautoclick.R
import com.example.appautoclick.databinding.ItemConditionCardBinding
...
class ConditionViewHolder(
    ...
    fun onBindCondition(condition: Condition, conditionClickedListener: (Int, Condition) -> Unit) {
        ...
        itemView.setOnClickListener { conditionClickedListener.invoke(adapterPosition, condition) }
