 ...
 */
package com.example.appautoclick.overlays.eventlist
...
import com.example.appautoclick.database.domain.Scenario
...
import com.example.appautoclick.databinding.DialogEventListBinding
    ...
    private fun toEditionMode() {
        dialog?.apply {
            ...
            changeButtonState(
                ...
                View.VISIBLE,
                R.string.dialog_event_list_add
            ) {
                onAddClicked()
            }
        }
