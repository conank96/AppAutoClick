 ...
 */
package com.example.appautoclick.overlays.copy.actions
...
import com.example.appautoclick.databinding.DialogActionCopyBinding
        ...
        lifecycleScope.launch {
            repeatOnLifecycle(Lifecycle.State.STARTED)  {
                viewModel?.actionList?.collect { actionList ->
                    ...
                    actionCopyAdapter.submitList(
                        if (actionList == null) ArrayList() else ArrayList(
                            actionList
                        )
                    )
                }
