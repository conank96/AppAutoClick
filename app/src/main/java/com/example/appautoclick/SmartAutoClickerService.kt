 ...
 */
package com.example.appautoclick
...
import com.example.appautoclick.activity.ScenarioActivity
import com.buzbuz.smartautoclicker.baseui.overlays.OverlayController
import com.example.appautoclick.overlays.mainmenu.MainMenu
import com.example.appautoclick.database.domain.Scenario
import com.example.appautoclick.engine.DetectorEngine
...
class SmartAutoClickerService : AccessibilityService() {
     ...
     * adb shell "dumpsys activity service com.buzbuz.smartautoclicker.debug/com.example.appautoclick.SmartAutoClickerService"
     */
